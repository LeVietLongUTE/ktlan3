...
public class Adapter_KhuyenMai extends RecyclerView.Adapter<Adapter_KhuyenMai.ViewHolder>{
    List<KhuyenMai> cofeModelList;
    int resource;


    public Adapter_KhuyenMai(List<KhuyenMai> cofeModelList, int resource){
    ...
    @NonNull
    @Override
    public Adapter_KhuyenMai.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_KhuyenMai.ViewHolder holder, int position) {
        KhuyenMai cofe=cofeModelList.get(position);
