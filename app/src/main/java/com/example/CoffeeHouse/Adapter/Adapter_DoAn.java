...
public class Adapter_DoAn extends RecyclerView.Adapter<Adapter_DoAn.ViewHolder> {
    List<DoAn> doanModelList;
    int resource;


    public Adapter_DoAn(List<DoAn>doanModelList, int resource){
        this.doanModelList=doanModelList;
        this.resource=resource;
    }
    @NonNull
    @Override
    public Adapter_DoAn.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(resource,parent,false);
        Adapter_DoAn.ViewHolder viewHolder=new Adapter_DoAn.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_DoAn.ViewHolder holder, int position) {
        DoAn doAn_124=doanModelList.get(position);
